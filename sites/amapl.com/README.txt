...
A faire sur la prod AMAPL :
activer le module amap_to_stripe
Vérifier que l'on est bien en prod sur le module stripe
/admin/config/workflow/rules/reaction/manage/rules_paiement : adhesions@amapl.com est l'expéditeur


Vérifier les styles d'image (grand je crois)

activer le module amapl_headband
