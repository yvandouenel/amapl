...
$title_class = (isset($node->field_session_target['und'][0]['value'])) ?
  ...
  //dpm($node);
  // gestion de l'url du titre cliquable
$url = (isset($node->field_news_url_target['und'][0]['value'])) ?
  $node->field_news_url_target['und'][0]['value'] :
  drupal_lookup_path('alias',"node/".$node->nid);

$target = (isset($node->field_news_new_window['und'][0]['value']) &&
  $node->field_news_new_window['und'][0]['value']) ?
  "_blank" :
  "_self";
