 ...
 */
?>
<header id="navbar" role="banner" class="custom-header">
  <div class="custom-top-menu">
    <div class="<?php print $container_class; ?>">
      <?php print render($page['header']); ?>
    </div> <!-- /#page-header -->
  </div>
  <div class="custom-headband">
    <div class="<?php print $container_class; ?>">
      <div class="navbar-header">
        <?php if ($logo): ?>
          <h1 id="h1-logo">
            <a class="logo navbar-btn " href="<?php print $front_page; ?>" >
              <img src="<?php print $logo; ?>" alt="lppl.fr, le portail des professions libérales - retour accueil" />
            </a>
          </h1>
        <?php endif; ?>
...
<?php if (!empty($page['footer'])): ?>
  <div id="custom-footer">
    <footer class="footer <?php print $container_class; ?>">
      ...
      <address>
        <p>Tél. : <a href="tel:+33466299610" class="phone">04 66 29 96 10</a> - GIE Constellians - 242 rue Claude Nicolas Ledoux, 30 900 Nîmes</p>
      </address>
    </footer>
  </div>
<?php endif; ?>
